...
exports.listAllPremades = function(req, res) {
    Premades.find({}, function(err, data) {
        if(err) throw err;
        res.json(data);
    });
};
...
exports.updatePremade = function(req, res) {
    Premades.update({_id: req.params.id}, req.body, {upsert: true, new: true}, function(err, data) {
        if(err) throw err;
...
exports.deletePremade = function(req, res) {
    Premades.remove({_id: req.params.id}, function(err, data) {
        if(err) throw err;
